...
#Region "Private Sub CompoundToMonthlyData()"
    Private Sub CompoundToMonthlyData()
        ...
        Const MaxMissingDays As Integer = 8
        ...
        For Each DataYear In intYears
            ...
            For j As Integer = 1 To 12
                ...
                Dim intPrecipNoDataDays As Integer = 0
                Dim DataMonth As Integer = j

                Dim daysInMonth = DateTime.DaysInMonth(DataYear, DataMonth)
                ...
                If (daysInMonth - lnqPrecipDataByMonth.Count()) > MaxMissingDays Then

                    ' iterating through every day in the month
                    For Each day In lnqPrecipDataByMonth

                        If StandardPrecipitationIndex.Missing.Contains(day.Value) Then

                            intPrecipNoDataDays += 1
                    ...
                    dblPrecip += StandardPrecipitationIndex.Missing(0)
                    intPrecipNoDataDays += (daysInMonth - lnqPrecipDataByMonth.Count())
                ...
                Else
                    ...
                    dblPrecip = IIf(intPrecipNoDataDays > MaxMissingDays, StandardPrecipitationIndex.Missing(0), dblPrecip)
